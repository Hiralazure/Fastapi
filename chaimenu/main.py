...
app = FastAPI(title="chai point menu API",description="Read only menu api")
...
def get_menu(category: str|None =Query(None,description="Filter by chai,snack or fast food")):
    if category:
